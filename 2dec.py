...
for password_entry in passwords:
    min_count = password_entry[0]
    max_count = password_entry[1]
    char = password_entry[2]
    password_str = password_entry[3]
    char_count = password_str.count(char)
    char_pos = password_str.find(char) + 1
    if (password_str[min_count - 1] == char) ^ (password_str[max_count - 1] == char):
        valid_passwords += 1
